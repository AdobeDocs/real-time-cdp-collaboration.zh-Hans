---
title: 概述
description: 了解如何使用 Adobe Real-Time Customer Data Platform (CDP) Collaboration，在不依赖第三方 Cookie 的情况下发现、激活并衡量高价值受众。
...
一旦您拥有访问权限，您就可以设置帐户并创建数据连接以开始获取受众。 阅读[端到端工作流](/help/guide/overview/end-to-end-workflow.md)以开始。
