...
要添加其他组织，请导航到左边栏中的&#x200B;**[!UICONTROL 设置]**，然后选择添加图标（![添加图标。](/help/assets/icons/plus.png)） 在右上角。 接下来，选择&#x200B;**[!UICONTROL 帐户]**。
...
选择&#x200B;**[!UICONTROL AdFixus ID]**&#x200B;时，您需要在&#x200B;**[!UICONTROL 帐户凭据]**&#x200B;部分提供来自外部合作伙伴的对应ID。 此选项仅在&#x200B;**[!UICONTROL AdFixus ID]**&#x200B;上切换&#x200B;*后*&#x200B;可用。 在&#x200B;**[!UICONTROL 帐户ID]**&#x200B;字段中输入您的AdFixus ID，并确保仔细检查该值是否准确。
...
出现&#x200B;**[!UICONTROL 匹配键]**&#x200B;对话框。 打开任何匹配的密钥，或者更新[!UICONTROL AdFixus ID]的&#x200B;**[!UICONTROL 帐户ID]**，然后选择&#x200B;**[!UICONTROL 保存]**&#x200B;以确认更改。
...
成功对话框用于确认帐户的匹配键已成功更新。

![确认帐户匹配密钥的成功对话框已成功更新。](/help/assets/setup/manage-account/match-key-updated-successfully.png){zoomable="yes"}
