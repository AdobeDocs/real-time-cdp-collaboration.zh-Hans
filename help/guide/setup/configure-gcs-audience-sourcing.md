...
>title="从 Google Cloud Storage 添加受众"
>abstract="要连接您的 Google Cloud Storage，请授权 Adobe 的服务用户能够检索您的受众数据以进行处理。 按照 Experience League 中列出的步骤，授予 Adobe 对您的 Google Cloud Storage 的访问权限。"
