...
>title="缺少身份标识"
>abstract="身份计数将在按照配置的时间表进行下次数据连接刷新后可用。 初始刷新通常发生在数据连接设置后的24小时内。 正在进行的刷新将遵循配置的时间表。 "
...
>[!NOTE]
>
>如果协作者将所有受众都设置为私人，则受众分析中的&#x200B;**[!UICONTROL 相关受众]**&#x200B;视图将为空白。 [了解更多信息](/help/guide/collaborate/discover.md#relevant-audiences)。
