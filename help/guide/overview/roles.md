...
代理是计划、管理和优化一个或多个品牌的营销和媒体活动的组织。 他们同时利用第一方和第三方数据，跨渠道构建、激活和衡量受众。 通过使用Collaboration，代理机构可以在一个受管理的环境中访问具有品牌权限的数据，以便协调跨合作伙伴活动、激活受众并提高媒体有效性。

## 数据合作伙伴 {#data-partner}

数据合作伙伴是这样的组织：提供第三方管理的数据集和区段，协作者可以将其用于丰富自己的数据，以实现受众定位、发现客户和进行测量。 使用Collaboration，数据合作伙伴可以安全地将此数据提供给协作者进行受众和活动分析，而无需将第一方数据传输到合作伙伴的环境中。
