...
建立帐户后，[!UICONTROL Luma]和[!UICONTROL TV Tube]都必须[创建数据连接和源受众](../setup/onboard-audiences.md)。 只有[!UICONTROL TV Tube]会激活营销活动的受众，因此他们需要[配置目标](../destinations/manage-destinations.md)。
...
建立帐户后，[!UICONTROL 适合服装]和[!UICONTROL Luma]都需要[创建数据连接和源受众](../setup/onboard-audiences.md)。 [!UICONTROL 适合服装]和[!UICONTROL Luma]都将激活营销活动的受众，因此它们都需要[配置目标](../destinations/manage-destinations.md)。
...
若要开始，[!UICONTROL Luma]需要使用广告商角色[创建帐户](../setup/onboard-account.md)。 建立帐户后，[!UICONTROL Luma]必须[创建数据连接和源受众](../setup/onboard-audiences.md)。 由于[!UICONTROL Luma]将激活营销活动的受众，因此他们需要[配置目标](../destinations/manage-destinations.md)。
...
建立帐户后，[!UICONTROL Luma]和[!UICONTROL DataM8]都必须[创建数据连接和源受众](../setup/onboard-audiences.md)。 两个协作者都可以为营销活动激活受众，因此他们各自需要[配置目标](../destinations/manage-destinations.md)。
...
建立帐户后，[!UICONTROL Agency99]和[!UICONTROL TV Tube]都必须[创建数据连接和源受众](../setup/onboard-audiences.md)。 [!UICONTROL Agency99]将在其工作区中设置客户端子帐户和源客户端数据。 只有[!UICONTROL TV Tube]会激活营销活动的受众，因此他们需要[配置目标](../destinations/manage-destinations.md)。
...
建立帐户后，[!UICONTROL Luma]和[!UICONTROL Holdco]都必须[创建数据连接和源受众](../setup/onboard-audiences.md)。 两个协作者都可以为营销活动激活受众，因此他们各自需要[配置目标](../destinations/manage-destinations.md)。 
